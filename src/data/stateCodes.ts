export const stateCodeToName: Record<string, string> = {
  ...
  BR: 'Bihar', CH: 'Chandigarh', CT: 'Chhattisgarh', DD: 'Dadra & Nagar Haveli',
  DL: 'Delhi', DN: 'Daman & Diu', GA: 'Goa', GJ: 'Gujarat',
  ...
  TN: 'Tamil Nadu', TR: 'Tripura', UP: 'Uttar Pradesh', UT: 'Uttarakhand',
  WB: 'West Bengal',
};
